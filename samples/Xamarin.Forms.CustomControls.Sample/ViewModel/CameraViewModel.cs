...
namespace Xamarin.Forms.Labs.Sample
{
	...
	public class CameraViewModel : Xamarin.Forms.CustomControls.Mvvm.ViewModel
    {
        /// <summary>
        /// The _scheduler.
        /// </summary>
        ...
        public Command SelectPictureCommand 
        {
            get {
				return selectPictureCommand ?? (selectPictureCommand = new Command (
					async () => await SelectMultiPicture (),
					() => true)); 
			}
        }
		...
		/// </summary>
		/// <returns>Select Picture Task.</returns>
		private async Task SelectMultiPicture()
		{
			Setup();
			...
			try
			{
				...
				var mediaFile = await this.mediaPicker.SelectMultiPhotoAsync(new CameraMediaStorageOptions
					{
						DefaultCamera = CameraDevice.Front,
						MaxPixelDimension = 400
					});
